...
function getTime(){
    ...
    fullDay.textContent = `${date} ${months[monthsTitle]}, ${year}`
...
// xatoni ko'rasatadigan funktsiya
...
formCreate.addEventListener('submit', (e) => {
    ...
    if(todoText.length){
        ...
        showMessage('message-create', 'Biror narsa yosiing...')
    }
})

// toDo ni o'chirish funktsiyasi
...
formEdit.addEventListener('submit', (e) => {
    ...
    if(todoText.length){
        ...
        showMessage('message-edit', 'Biror narsa yosiing...')
    }
})
